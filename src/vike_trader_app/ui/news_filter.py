...
("Provider" / "Provider (3)" with a unified chevron) that opens the shared dark checklist
popover (header, search, checkbox rows, Select-all). Kept as a named class so the News space's
imports and usages stay unchanged. Empty selection == no constraint (all).
"""
