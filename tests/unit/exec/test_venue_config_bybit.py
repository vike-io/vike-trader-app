"""Bybit venue dispatch: demo/mainnet REST, empty WS (deferred), BybitV5Signer; absent creds -> None.
...
def test_bybit_demo_uses_demo_rest_empty_ws_and_bybit_signer():
...
def test_bybit_mainnet_uses_production_rest():
